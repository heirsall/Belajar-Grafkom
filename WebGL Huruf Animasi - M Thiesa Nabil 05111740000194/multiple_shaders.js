(function(global) {
    ...
    function initBuffersTriangle() {
        var vertices = new Float32Array([
            ...
            +0.60, +0.47,   0.3, 0.0, 0.2,
            +0.10, +0.30,   0.0, 0.0, 0.5,
            +0.60, +0.30,   0.0, 0.0, 0.4,
    
            +0.60, +0.47,   0.3, 0.0, 0.3,
            +0.10, +0.30,   0.1, 0.0, 0.4,
            +0.10, +0.47,   0.1, 0.0, 0.7,
    
            +0.40, +0.30,   0.1, 0.0, 0.3,
            +0.40, -0.55,   0.1, 0.0, 0.0,
            +0.30, -0.55,   0.0, 0.0, 0.4,
    
            +0.40, +0.30,   0.3, 0.0, 0.0,
            +0.30, +0.30,   0.1, 0.0, 0.2,
            +0.30, -0.55,   0.1, 0.0, 0.4,
    ...
    function draw(){
        ...
        function render(){
            ...
            theta2 += Math.PI * 0.0194;
            gl.uniform1f(theta2Loc, theta2);

            if(isGrow) {scale += 0.0194}
            else{
                scale -= 0.0194;
            }
